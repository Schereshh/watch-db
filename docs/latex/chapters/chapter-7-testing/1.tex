...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\textwidth]{chapters/chapter-7-testing/failing-pipeline.png}
    \caption{Sikertelen CI pipeline a GitHub Actions felületén}
    \label{fig:failing-pipeline}
\end{figure}
